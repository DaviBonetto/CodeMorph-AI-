...
export const Rocket = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S5.21 15.66 4.5 16.5z"/><path d="m12 15-3-3a2.25 2.25 0 0 1 0-3l3-3a2.25 2.25 0 0 1 3 0l3 3a2.25 2.25 0 0 1 0 3l-3 3a2.25 2.25 0 0 1-3 0z"/><path d="m21.5 21.5-3-3"/><path d="m6.5 6.5-3-3"/></svg>
);
...
export const Accessibility = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="5" r="1"/><path d="M12 18H6l-4-5h14l-4 5"/><path d="M12 11.5a2.5 2.5 0 0 1-5 0V9a2.5 2.5 0 0 1 5 0"/><path d="m14 12 5 6"/><path d="m12 12 5-6"/></svg>
);

export const Smartphone = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="6" y="2" width="12" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
);
...
export const Wand2 = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 3-1.5 1.5 3 3L12 9l-1.5 1.5 3 3L12 15l-1.5 1.5 3 3L12 21M9 3l1.5 1.5-3 3L9 9l1.5 1.5-3 3L9 15l1.5 1.5-3 3L9 21"/></svg>
);
...
// Replaced the image logo with a styled text logo as requested.
export const CodeMorphFullLogo = (props: React.HTMLAttributes<HTMLSpanElement>) => (
    <span className="text-3xl font-bold tracking-tight text-text-primary" {...props}>
        CodeMorph AI
    </span>
);
